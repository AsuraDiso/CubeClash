...
namespace Game.Scripts.Core.Data.Cards
{
    ...
    public struct CardFootprintSize : IEquatable<CardFootprintSize>
    {
        ...
        public bool Equals(CardFootprintSize other) => Columns == other.Columns && Rows == other.Rows;

        public override bool Equals(object obj) => obj is CardFootprintSize other && Equals(other);

...
namespace Bootstrap.UI.Controllers
{
    public sealed class BattleController : IStartable, IDisposable
    {
        ...
        public BattleController(IUiViewFactory viewFactory, IBattleControllerRegistry controllerRegistry,
        ...
        public void Start()
        {
            ...
            if (_controllerRegistry.Current != null) BindGateway(_controllerRegistry.Current);
